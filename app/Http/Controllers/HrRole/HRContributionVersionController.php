...
class HRContributionVersionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('HR/Contributions/index', [
    ...
    public function create()
    {
        ...
        return Inertia::render('HR/Contributions/create');
    }
    ...
    public function store(StoreContributionRequest $request, CreateNewContribution $action)
    {
        ...
        try {
            ...
            return to_route('hr.contribution-versions.index')->with('success', 'Contribution created successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function edit(ContributionVersion $contributionVersion)
    {
        ...
        return Inertia::render('HR/Contributions/edit', compact('contributionVersion'));
    }
    /**
    ...
    public function update(UpdateContributionRequest $request, ContributionVersion $contributionVersion, UpdateContribution $action)
    {
        ...
        try {
            ...
            return to_route('hr.contribution-versions.index')->with('success', 'Contribution updated successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function destroy(ContributionVersion $contributionVersion)
    {
        ...
        return to_route('hr.contribution-versions.index')->with('success', 'Contribution deleted successfully.');
    }
}
