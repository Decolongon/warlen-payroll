...
class EmployeeSeeder extends Seeder
{
    ...
    private function getUsersData(): array
    {
        ...
        $rawNewEmployees = [
            ...
            [6, 'WelbertDatoon'],
            [115, 'JonaDelicana'],
            [646, 'MarinyDelrosario'],
            [220, 'ShanineNatalio'],
            [1, 'AileenEsplaguera'],
            [450, 'JuleeSagal'],
            [131, 'RecajeanDesacula'],
            [12, 'LeonelFermiza'],
            [54, 'JerwinNierves'],
            [671, 'RossethFormanes'],
            [214, 'NicaGonzale'],
            ...
            [887, 'Manilyn Estorco'],
            [9, 'Gilbert Saluta'],
            [273, 'Casipong Antonio'],
            [882, 'Christian Mariano'],
            [66, 'BENNYALLADIN'],
            [71, 'Primitiva Alladin'],
            [683, 'Marjorie Galario'],
            [867, 'NoliRodriguez'],
            [651, 'HandellRonquillo'],
            [916, 'Angela Canaya'],
            [746, 'Lorenz Monton'],
            [215, 'Russel John Tuya'],
            [909, 'LULENORALFORPUE'],
            [915, 'LEO GESTER CANETE'],
            [890, 'JOHN VINCENT SALINAS'],
            [18, 'RUEL HERMINANDA'],
            [734, 'ELLA PAGLOMUTAN'],
            [888, 'ERROL BIONA'],
            [728, 'JOHN CHRISTIAN TALAMAN'],
            [97, 'DEMMY CORDOVA'],
            [914, 'Jason Cuberos'],
            [897, 'John Rhyan Cancian'],
            [364, 'Joseph Amant'],
            [206, 'Diosdado Gonzaga Ii'],
            [222, 'BILLY JOHN BARSANAS'],
            [172, 'JOME GRUZO'],
            [174, 'JOEL SEDERIO'],
            [736, 'MELODY SENTOY'],
            [912, 'JAMBIE REYES'],
            [816, 'ALISASIS ELFRED'],
            [111, 'ERICKSON DELOGAR'],
            [917, 'BRENT MISPENAS'],
            [898, 'BREY BRYAN DAYDAY'],
            [799, 'JUAN CADUNGON'],
            [695, 'HELBERT ALMANOCHE'],
            [831, 'RONDEL EDANGGA'],
            [880, 'CHRISTIAN MATA'],
            [710, 'RODNEY PARCON'],
            [112, 'RYAN SAMUEL SUSADA'],
            [588, 'VITO MACARIO'],
            [30, 'JOHN LE  MONTANO'],
            [779, 'RYAN BENGUELO'],
            [668, 'PAUL JOHN DENAGA'],
            [418, 'JERIC DESLATE'],
            [47, 'RENz ESPINOSA'],
            [737, 'RONEL TULIO'],
            [884, 'JOSEPH JOHN LAURE'],
            [46, 'JUNEDY GALLETO III'],
            [910, 'SHARMINE BAYOT'],
            [942, 'HILARY FICA'],
            [654, 'BOBBY LABRADOR'],
            [953, 'MA JESSA BALIBALOS'],
            [625, 'ARLAN IGMEDIO'],
            [124, 'ELSIE AQUINO'],
            [960, 'NORMAN LAUSA'],
            [877, 'NONATO EDISON'],
            [878, 'ABELLANO JES MARTIN'],
            [626, 'GERALD GENTEROLES'],
            [961, 'CREZELLE ANN VILLANUEVA'],
            [678, 'JOHN  LOVELL ZERRUDO'],
            [963, 'ANDREW HUERVA'],
            [268, 'Jerone Vista'],
            [968, 'REMY QUIJANO'],
            [972, 'Jame Kyle Penequito'],
            [973, 'De~Ann Manocan'],
            [974, 'WENNAH OBEDIENTE'],
            [299, 'RYAN COSEBA'],
            [313, 'GLYN TINGSON'],
            [976, 'JUSTINE CONSTANTINO'],
            [977, 'WILMAR VILLEGAS'],
            [979, 'REDEN ALIMANTE'],
            [978, 'EDWARD ZASPA'],
            [980, 'JASSEN PADILLA'],
            [984, 'MARAH ZARAGOSA'],
            [970, 'Ace Andrian Barredo'],
            [971, 'Xhar Jhon Suarez'],
            [883, 'Timothy Montero'],
            [845, 'ROMME PAHILANGA'],
            [992, 'BELLA PORNALES'],
            [1017, 'KIRB GASCON'],
            [1019, 'JOHNEL DOROIN'],
            [1021, 'JOHN NEIL BACHOCO'],
            [1025, 'MAMERTO VILLAREAL'],
            [1026, 'ADONIS LADDARAN'],
            [600, 'JERNELL GARCIA~'],
            [808, 'KLEO SANDY'],
            [183, 'JASON LOZADA'],
            [539, 'ALIXANDER NONO'],
            ...
            [168, 'BREX DATOON'],
            [8, 'CHRISTINE NOBLEZA'],
            [1042, 'LOUIE JAY AGUILLON'],
            [1045, 'ARGIE LAGATIMAN'],
            [1044, 'ALEJO LAMPASO'],
            [1057, 'KENT ALISON'],
            [1073, 'ERAIZA FEJER'],
            [1074, 'ALPHA OMEGA OLAYBAR'],
            [1093, 'ELIJAH MONTON'],
            [1094, 'LAARNE LUMOGDANG'],
            [1095, 'CRISTA MAE   LIZA'],
            [1099, 'FUENTEBELLA JOHN EARL'],
            [581, 'BASAS JOFFREY'],
            [425, 'MELFRED PAGLINAWAN'],
            [1121, 'JAMES DURAY'],
            [332, 'VICTORIO HENDEN'],
            [1102, 'EDMUNDO Laurencio'],
            [1039, 'REY CABUNGCAG'],
            [995, 'EPIPANIO BALIJADO'],
            [1023, 'RALPH ARIBATO'],
            [1040, 'JOE PIT SAZON'],
            [786, 'CHRISTIAN RICO'],
            [1041, 'MARK GOMEZ'],
            [1134, 'MEG JULIANNE VILLACASTI'],
            [1143, 'LEONELFERMIZA'],
            [1148, 'IRISH GRACE TICAR'],
            [1164, 'CANTOR RHYNEXELLE'],
            [1165, 'COJA HANA JANELLE'],
            [1169, 'EVAN  JAMES BARBON'],
            [1175, 'JIMENA MACANDILI'],
            [1178, 'JOSEPH PENAFIEL'],
            [1184, 'Jenelyn Viajedor'],
            [1213, 'DOMINADOR ALCON JR'],
            [1215, 'CEJIE ALTAS'],
            [1214, 'ELEUBERT MERABE'],
            [1216, 'MARIE ARENDON'],
            [1130, 'GERALD DUAZO'],
            [1222, 'CINDY JOY TAGLE'],
            [1218, 'ANNE IWAYAN'],
            [891, 'MARK ANTHONY ORENCIO'],
            [1231, 'LOUISE AGNAS'],
            [1232, 'BEATRICE DEOCAMPO'],
            [1233, 'ALISTER ARROS'],
            [1037, 'JOSHUA SONIER'],
            [1228, 'JOHN MICHAELBULOS'],
            [1217, 'BRYAN BALBOA'],
            [1219, 'JETHRO PECHAYCO'],
            [1220, 'GLENN GASAPO'],
            [1235, 'MARY JOY JAVOC'],
            [1236, 'FRITZIE GRACE FRAYCO'],
            [1237, 'MARY  JOY  BALOYO'],
            [1258, 'FRANCIS COLMENARES'],
            [1260, 'DOMINIC LASPONIA'],
            [1275, 'GEREBELO ANGCO'],
            [1276, 'YDRYAN CABALINAN'],
            [1277, 'RIO JHOY DELOS SANTOS'],
            [1278, 'NICHOLE MATI~ONG'],
            [1279, 'RAYSELLE CABAN'],
            [1280, 'JOHN GODWIN MAMIGO'],
            [1287, 'JASMIN GENOVIA'],
            [1298, 'ANGELO TORRECAMPO'],
            [893, 'BRIGEDO CARASAQUIT'],
            [210, 'MARLO BALOLOT'],
            [642, 'MARK MENGULLO'],
            [1348, 'AGUIDA SANTILLAN'],
            [1349, 'SAYRON BERMEO'],
            [1352, 'CASELYN BANHAO'],
            [1381, 'JUNALYN COMBESTRA'],
            [1402, 'GENARA DUCASI'],
            [1432, 'BRIAN JIMENA'],
            [1431, 'RAFAEL PERLADO'],
            [962, 'JHON ERNIE SERANA'],
            [1441, 'MAE ANNECHELL SUSTIOSO'],
            [1442, 'CLARIS ANN DEQUILLA'],
            [1444, 'GODFREY CORTEZA'],
            [1447, 'RONIMAE KATE VICENTE'],
            [1450, 'GILBERT TACUYAN'],
            [1460, 'YVONNE LOBATON'],
            [1457, 'MICHAEL GABAN'],
            [1458, 'ANN JELO JOSH AGBAY'],
            [1464, 'KENT GERRY DIAPEN'],
            [1465, 'JERICHO FRANCIS BABA'],
            [1470, 'BIEN PAHILANGA'],
            [1471, 'KLYNT SALGADO'],
            [1482, 'CRISPHER PENAROYO'],
        ];
